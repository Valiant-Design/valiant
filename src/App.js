...
// import image_5 from "./images/download (5).jpg";
// import image_7 from "./images/download (7).jpg";
...
function App() {
  //useState for storing string, object, array, boolean, numbers 
  ...
  // }
  // const handleEmail = (e) => {
  //   setEmail(e.target.value)      //This is a function that works with onchange to Update and tract what the user is typing in the state email. Hence if it is empty then the input box is void 
  //   console.log(e.target.value)
  // }
  // const handleAge = (e) => {
  ...
  return ( 
    ...
    // </div>
      ...
      <div>
        ...
        <input className="form-control mt-2" onChange={handlePassword} value={password} placeholder="password" />
